...
```{r line plot average syn vs asyn, fig.cap = "Average Duration for Syn and Asyn"}
...
```{r Histogram substracted difference syn - asyn, fig.cap = "Histogram for substracted difference"}
