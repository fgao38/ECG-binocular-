...
```{r function to read and compile all participants' file, message = FALSE, warning = FALSE}
...
```{r line plot average syn vs asyn}
...
```{r Histogram substracted difference syn - asyn}
